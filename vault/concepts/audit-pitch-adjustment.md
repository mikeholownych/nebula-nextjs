# Audit Pitch Adjustment for Self-Sufficient Founders
...
## HOT_LEAD Tracking
When a warm lead expresses interest but objects to the implementation framing, update `HOT_LEAD.json` with `pitch: "call_or_fix_list_97"` so follow-up scripts don't send the standard implementation email.