...
Usage:
  python scripts/acquisition_cli.py run [--days 28] [--comparator-id meas_...] [--dry-run]
...
def cmd_run_measurement(args):
    ...
    # Calculate exact canonical window
    ...
    if start_d and end_d:
        ...
        eff_start, eff_end = calculate_canonical_window(end_date=end_d, days=args.days)
