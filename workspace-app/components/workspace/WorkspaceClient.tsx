  ...
  useEffect(() => {
    ...
    try {
      ...
      if (urlProject) {
        ...
        try { localStorage.setItem('nebula_workspace_project', urlProject) } catch {}
      } else {
        try {
    ...
    try {
      ...
      if (next.project !== undefined) {
        if (next.project === 'all') {
          ...
          try { localStorage.removeItem('nebula_workspace_project') } catch {}
        } else {
          params.set('project', next.project)
          try { localStorage.setItem('nebula_workspace_project', next.project) } catch {}
        }
