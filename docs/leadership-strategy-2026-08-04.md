...
**Status: COMPLETE 2026-08-05 (widget + auto-provision + sales page + recruitment playbook).**
...
- **UPDATE 2026-08-05:** Auto-provision implemented — Stripe webhook detects `offer_key=agency_partner`, collects agency domain at checkout, creates partner row via platform API, fires Telegram alert with embed code. Sales page live at `/agency-partner`. Recruitment playbook at `docs/playbooks/agency-recruitment-2026-08.md`. Ready to recruit.
