# Pre-Launch Press & Directory Seeding Strategy
## Objective: Maximize PH launch day signal by having media & directory coverage live BEFORE launch

**Timing**: All submissions T-14 to T-7 before PH launch day. Press pitches T-10 to T-5.

---

## Tier 1: Startup Directories (submit T-14 to T-10)
These create permanent indexed pages that AI engines crawl. Each is a third-party entity definition.
...
## Tier 2: News Media Pitches (send T-10 to T-5)
...
## Tier 3: Pre-Launch Content Seeding (T-14 to T-7)
...
**PH Launch Day: Tuesday, September 2, 2026** (Tuesdays get peak PH traffic; Sep 1 Monday is clear of holidays)

```
Aug 18 (T-15)  Submit all 8 directories
Aug 19 (T-14)  Create G2 vendor profile
Aug 22 (T-11)  Publish original research piece (Medium + LinkedIn)
Aug 22 (T-11)  Send Tier A press pitches (MarTech, SEJ, CXL)
Aug 25 (T-8)   Send Tier B press pitches (BetaKit, IH, SaaS newsletters)
Aug 27 (T-6)   Follow up on Tier A non-responses
Aug 29 (T-4)   Confirm BetaList listing is live
Aug 31 (T-2)   Post Indie Hackers thread (soft launch, builds audience)
Sep 1  (T-1)   Queue Show HN post for launch morning; prep PH assets
...
## What Each Placement Achieves for AI Citation

| Placement | Citation query it covers |
|-----------|------------------------|
| BetaList | "new landing page tools 2026" |
| AlternativeTo | "Unbounce alternatives", "Hotjar alternatives" |
| SaaSHub | "landing page audit tools comparison" |
| MarTech coverage | "AI CRO tools", "landing page audit" (broad) |
| SEJ coverage | "conversion optimization tools 2026" |
| Medium data piece | "landing page conversion statistics 2026" |
| ProductHunt | "is Nebula Components worth it", "Nebula reviews" |
| Indie Hackers | "best landing page audit for startups" |
...
| Medium/LinkedIn publishing | $0 | Yes |

**Total required spend: $129** (BetaList premium only)

---

## Success Criteria

Before PH launch day, at minimum:
- [ ] 5+ directory listings live and indexed
- [ ] 1+ press coverage published (any tier)
- [ ] Original research piece live on Medium + LinkedIn
- [ ] Indie Hackers thread with 10+ comments
- [ ] "Nebula Components" returns correct entity on Google (not bike parts)
