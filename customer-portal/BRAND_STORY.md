...
Every piece of copy, every headline, every outreach message anchors to this claim.

---

## 3. Who We Serve

**Primary:** Founders and solo operators actively spending on paid ads (Google, Meta, LinkedIn) whose landing pages aren't converting at the rate their click-through should predict.

Sub-segments:
- Ecommerce brands: strong CTR, weak checkout conversion
...
**The funnel:** Free audit is acquisition. The $97 Sprint is the product. The audit *is* the diagnosis; the Sprint is the cure. No retainer waiting behind either one.
...
| ✅ Use | ❌ Avoid |
|---|---|
| Audit | Page health check, scan, report |
| Finding | Error, issue, problem, suggestion |
| Signal | Component, metric, category |
| Score (0–100 internal) / Grade (A–F display) | Don't conflate the two |
| One-Leak Repair Sprint | Fix Pack, service, package |
| Platform API | Service, backend |
| Workspace | Dashboard |
| Evidence | Insight, recommendation |
| Defect | Opportunity (we're not a CRO agency) |

---

## 9. Anti-References (What We Are Not)

Never look or sound like:
- Generic AI-SaaS aesthetics (cream backgrounds, pastel gradients)
- CRO-agency theatrics ("unlock your potential")
- "Black-box AI says so" interfaces
- Space-themed novelty branding
- Cybersecurity product styling
- Enterprise analytics polish
- Cheap audit generator feel
- Digital marketing guru funnel aesthetics
- Website design studio portfolio look
...
## 12. Channel Voice Notes

**Site copy:** Clinical, precise, short sentences. Lead with the finding, not the feature.
...
A customer who finishes the Sprint says:
> *"I know exactly what was broken, what was changed, and I can see the difference."*

Not: *"That was a great experience."*
Not: *"The team was so helpful."*

Outcome clarity is the brand promise. Deliver that or the positioning is hollow.

---

## 14. Aggregate Data as Brand Position

Nebula holds original data no competitor can replicate: real audit scores across real pages, with evidence attached to every finding.

**Current live data points:**
- Average score: 6.2/10 (Grade C) across all audited pages
