...
export const metadata: Metadata = {
  ...
  description: 'Side-by-side comparisons of Nebula against PageSpeed Insights, HubSpot Website Grader, Nibbler, and Google Lighthouse — what each checks, costs, and who it is for.',
  alternates: {
