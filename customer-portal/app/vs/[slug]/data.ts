...
export const COMPARISONS: Record<string, Comparison> = {
  ...
  "unbounce": {
    ...
    bluf: "Unbounce is a landing page builder with built-in A/B testing starting at $29/month. Nebula is a free conversion audit that works on the landing page you already have — Webflow, Framer, Shopify, WordPress, anything. You do not rebuild the page; Nebula tells you exactly why it is not converting and what to fix, in under 2 minutes.",
    checkedAt: "August 2026",
