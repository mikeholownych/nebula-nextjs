...
export const COMPARISONS: Record<string, Comparison> = {
  "pagespeed-insights": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "Free", nebulaWins: false },
      ...
      { feature: "Fix path included", nebula: "$97 self-implementation kit — exact copy, code, or config changes", competitor: "Developer-level suggestions only — no implementation", nebulaWins: true },
  ...
  "hubspot-website-grader": {
    ...
    rows: [
      ...
      { feature: "Fix path included", nebula: "$97 self-implementation kit targeted to your specific failing signals", competitor: "Generic tiered recommendations only — no implementation instructions", nebulaWins: true },
  ...
  "google-lighthouse": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "Free — built into Chrome DevTools or CLI", nebulaWins: false },
      ...
      { feature: "Fix path", nebula: "$97 self-implementation kit — copy, code, or config changes written for your page", competitor: "Developer-facing suggestions — no implementation path for marketers", nebulaWins: true },
  ...
  "hotjar": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "Free (35 daily sessions), Plus $32/mo, Business $80/mo", nebulaWins: true },
      ...
      { feature: "Checks conversion signals", nebula: "Yes — message match, CTA, trust, above-fold, form friction", competitor: "No — shows click, scroll, and move behaviour only", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 self-implementation kit targeted to your specific failing signals", competitor: "No — data only, no remediation guidance", nebulaWins: true },
    ],
  ...
  "semrush-site-audit": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "SEMrush Pro $139.95/mo (includes Site Audit)", nebulaWins: true },
      { feature: "Checks conversion signals", nebula: "Yes — message match, CTA, trust, above-fold, form friction", competitor: "No — 130+ technical SEO checks only", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 self-implementation kit — conversion-specific remediation", competitor: "Issue list with priority scores — no ad/conversion guidance", nebulaWins: true },
    ],
  ...
  "crazy-egg": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "Starter $49/mo, Plus $99/mo, Pro $249/mo", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 self-implementation kit for your specific failing signals", competitor: "No remediation — data visualisation only", nebulaWins: true },
    ],
  ...
  "screaming-frog": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "Free (500 URL limit), Paid £199/year", nebulaWins: true },
      ...
      { feature: "Checks conversion signals", nebula: "Yes — message match, CTA, trust, above-fold, form friction", competitor: "No — technical SEO data only", nebulaWins: true },
      ...
      { feature: "Message-match check", nebula: "Yes", competitor: "No", nebulaWins: true },
      { feature: "Fix path included", nebula: "$97 self-implementation kit — plain-English conversion fixes", competitor: "Raw data export — requires developer to interpret and act", nebulaWins: true },
    ],
  ...
  "google-analytics": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 self-implementation kit", competitor: "Free (GA4); Analytics 360 enterprise pricing", nebulaWins: false },
      ...
      { feature: "Checks conversion signals", nebula: "Yes — message match, CTA, trust, above-fold, form friction, AI readiness", competitor: "No — measures traffic, events, and goals after the fact", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 self-implementation kit — targeted to your specific failing signals", competitor: "No — data reporting only, no remediation", nebulaWins: true },
    ],
