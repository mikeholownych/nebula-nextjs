...
export const COMPARISONS: Record<string, Comparison> = {
  ...
  "hotjar": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 fix prompts", competitor: "Free (35 daily sessions), Plus $32/mo, Business $80/mo", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 AI prompts targeted to your specific failing signals", competitor: "No — data only, no remediation guidance", nebulaWins: true },
    ],
  ...
  "semrush-site-audit": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 fix prompts", competitor: "SEMrush Pro $139.95/mo (includes Site Audit)", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 AI prompts — conversion-specific remediation", competitor: "Issue list with priority scores — no ad/conversion guidance", nebulaWins: true },
    ],
  ...
  "crazy-egg": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 fix prompts", competitor: "Starter $49/mo, Plus $99/mo, Pro $249/mo", nebulaWins: true },
      ...
      { feature: "Fix path included", nebula: "$97 AI prompts for your specific failing signals", competitor: "No remediation — data visualisation only", nebulaWins: true },
    ],
  ...
  "screaming-frog": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 fix prompts", competitor: "Free (500 URL limit), Paid £199/year", nebulaWins: true },
      ...
      { feature: "Message-match check", nebula: "Yes", competitor: "No", nebulaWins: true },
      { feature: "Fix path included", nebula: "$97 AI prompts — plain-English conversion fixes", competitor: "Raw data export — requires developer to interpret and act", nebulaWins: true },
    ],
  ...
  "google-analytics": {
    ...
    rows: [
      { feature: "Cost", nebula: "Free audit + $97 fix prompts", competitor: "Free (GA4); Analytics 360 enterprise pricing", nebulaWins: false },
      ...
      { feature: "Fix path included", nebula: "$97 AI prompts — targeted to your specific failing signals", competitor: "No — data reporting only, no remediation", nebulaWins: true },
    ],
