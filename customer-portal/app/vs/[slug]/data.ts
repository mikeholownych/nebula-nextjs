...
export const COMPARISONS: Record<string, Comparison> = {
  ...
  "hubspot-website-grader": {
    ...
    rows: [
      ...
      { feature: "Checks conversion criteria", nebula: "Yes — 9 signals including CTA, trust, social proof, message match", competitor: "No — performance, SEO, mobile, security only", nebulaWins: true },
