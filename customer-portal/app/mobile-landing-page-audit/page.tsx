      ...
      <main id="main-content" className="min-h-screen bg-bg pt-24 pb-16">
        <article className="mx-auto max-w-4xl px-6">
          ...
          <header className="mb-12">
            ...
            <h1 className="heading-1 text-fg md:text-5xl">Run a Free Mobile Landing Page Audit to Stop Wasted Ad Spend</h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <Link
              href="/audit?utm_source=mobile-audit-hero&utm_medium=hero-cta"
