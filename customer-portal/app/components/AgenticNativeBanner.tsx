...
export default function AgenticNativeBanner() {
  return (
    <section className="border-b border-border bg-bg-panel px-6 py-12">
      <div className="mx-auto max-w-6xl rounded-lg border border-border bg-bg-surface p-6 md:p-8">
        <div className="grid gap-6 md:grid-cols-[1.5fr_1fr] md:items-center">
          ...
          <div className="flex flex-col gap-3 rounded-lg border border-border bg-bg-elevated p-4">
            ...
            <Link
              ...
              className="text-xs font-semibold text-accent hover:text-fg transition-colors text-right"
            >
