      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-fg md:text-3xl">
            How much is a leaking page costing you right now?
          </h2>
          <p className="mt-2 text-sm text-fg-muted">
            Enter your numbers. See the monthly bleed before you scroll further.
          </p>
        </div>
              ...
              <>
                ...
                <div className="bg-signal-fail/8 border-b border-signal-fail/20 p-6 text-center">
                  ...
                  <p className="mt-1 text-sm text-fg-muted">
                    That&apos;s {fmt(wastedAnnual)} this year if nothing changes.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border">
                  ...
                  <div className="p-5 text-center">
                    ...
                    <p className="mt-0.5 text-xs text-fg-muted">conversions lost vs 2% baseline</p>
                  </div>
                  <div className="p-5 text-center">
                    <p className="text-2xl font-bold text-fg">{(currentCR * 100).toFixed(1)}% → 2%</p>
                    <p className="mt-0.5 text-xs text-fg-muted">the gap the page needs to close</p>
                  </div>
                </div>
