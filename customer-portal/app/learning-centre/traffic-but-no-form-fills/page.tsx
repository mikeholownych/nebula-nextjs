      ...
      <div className="mx-auto max-w-3xl px-6 py-14">
        ...
        <section className="mt-6 rounded-md border border-border bg-bg-panel p-8">
          ...
          <div className="space-y-1">
            ...
            <Link href="/learning-centre/landing-page-not-converting" className="block text-accent hover:text-fg transition-colors">Landing Page Not Converting: The Full Diagnostic Checklist →</Link>
            ...
            <Link href="/learning-centre/mobile-landing-page-leaks" className="block text-accent hover:text-fg transition-colors">Mobile Landing Page Leaks: Why Mobile Visitors Don't Convert →</Link>
          </div>
        </section>
      </div>
    </main>
