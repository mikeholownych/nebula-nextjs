...
export default function LandingPageBounceRateHigh() {
  ...
  return (
    <>
      ...
      minHeight: '100vh',
      background: 'radial-gradient(circle at top left, #152033, #080a0f 42%)',
      color: '#f5f7fb',
      padding: '40px 24px',
      maxWidth: '900px',
      margin: '0 auto',
      ...
      <p style={{ color: '#9ca3af', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '12px' }}>
        Landing Page Leaks · Bounce Rate
      </p>

      <h1 style={{ fontSize: '36px', fontWeight: 700, lineHeight: 1.2, marginBottom: '24px', color: '#f5f7fb' }}>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '24px', fontWeight: 600, marginBottom: '16px', color: '#f5f7fb' }}>
          Bounce vs Exit: What's the Difference
        </h2>
        <p style={{ color: '#9ca3af', lineHeight: 1.7 }}>
          <strong style={{ color: '#f5f7fb' }}>Bounce</strong> means someone landed on your page and left without clicking anything. They didn't explore. They didn't convert. They just... left.
          <br /><br />
          <strong style={{ color: '#f5f7fb' }}>Exit</strong> means they visited multiple pages and this was their last stop. Exit rate on a landing page is actually normal—if they clicked around and then left, your page did its job.
          <br /><br />
      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <ul style={{ color: '#9ca3af', lineHeight: 2, paddingLeft: '24px' }}>
          <li><strong style={{ color: '#f5f7fb' }}>By source:</strong> Google Ads vs Meta Ads vs Organic. One may be misconfigured.</li>
          <li><strong style={{ color: '#f5f7fb' }}>By device:</strong> Mobile bounce &gt;80% means your mobile layout is the problem.</li>
          <li><strong style={{ color: '#f5f7fb' }}>By traffic type:</strong> Cold traffic bounces more.Warm traffic converts more. Adjust expectations accordingly.</li>
        </ul>
      </section>
      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(16, 185, 129, 0.05))', border: '1px solid #10b981', borderRadius: '8px', padding: '24px' }}>
          <ol style={{ color: '#f5f7fb', lineHeight: 2, paddingLeft: '24px', margin: 0 }}>
      ...
      <section style={{ marginTop: '60px', paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '16px', color: '#f5f7fb' }}>
          Related Leak Checks
        </h2>
