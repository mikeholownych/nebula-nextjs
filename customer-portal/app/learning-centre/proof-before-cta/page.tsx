...
<p class="eyebrow">Trust Leaks · proof before cta</p>
<h1>Proof Before CTA: The Simple Fix Most Landing Pages Miss</h1>
<p class="lede">Most pages ask before they prove. If the visitor has not seen evidence, the CTA feels like risk. Put proof before the ask.</p>
<section class="panel">
<h2>Quick diagnosis</h2>
<p>Most pages ask before they prove. If the visitor has not seen evidence, the CTA feels like risk. Put proof before the ask.</p>
</section>
<section class="panel">
<h2>Checklist</h2>
<ul><li>Is the proof specific, not generic?</li>
<li>Is there one relevant example above the first major CTA?</li>
<li>Does proof match the buyer's problem?</li>
<li>Are claims backed by visible artifacts?</li>
<li>Can the proof be understood in 10 seconds?</li></ul>
</section>
<section class="panel">
<h2>Example</h2>
<p>A screenshot, before/after, or exact leak map beats a vague testimonial about being 'great to work with.'</p>
</section>
