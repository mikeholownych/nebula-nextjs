    ...
    <>
      ...
      <div className="max-w-[720px] mx-auto px-6 pt-28 pb-20">
        ...
        <div className="bg-bg-panel border border-border rounded-[10px] p-5 mb-4">
          ...
          <p className="m-0 text-[0.95rem] text-fg-muted">Google data shows a 1-second delay reduces conversions by 7%. Akamai research found that a 2-second load time has a higher bounce rate than a 1-second load time. On paid ad campaigns, slow load time means paying the same per click to convert fewer visitors.</p>
        </div>
        <div className="bg-bg-panel border border-border rounded-[10px] p-5 mb-4">
          <h3 className="m-0 mb-2 text-base font-bold text-fg">What is the fastest way to improve landing page load speed?</h3>
          <p className="m-0 text-[0.95rem] text-fg-muted">Compress and convert images to WebP format: this is typically the highest-impact change. Images are responsible for 60 to 80 percent of page weight on most landing pages. Next: defer or remove render-blocking JavaScript. Third: check for and remove redundant third-party scripts (chat widgets, analytics, pixel tags that load synchronously).</p>
        </div>
        <div className="bg-bg-panel border border-border rounded-[10px] p-5 mb-4">
        ...
        <div className="bg-bg-panel border border-border rounded-[10px] p-5 mb-4">
          ...
          <p className="m-0 text-[0.95rem] text-fg-muted">Yes. Google&apos;s landing page experience component of Quality Score includes load speed. A slow landing page lowers your Quality Score, which increases your cost-per-click.</p>
        </div>

        <section className="bg-bg-panel border border-border rounded-[10px] p-5 mt-12">
          <h3 className="text-base text-fg-muted m-0 mb-3">Related Articles</h3>
          <a className="block text-accent no-underline text-[0.95rem] mb-2 hover:text-accent-light transition-colors" href="/why-is-my-landing-page-not-converting">Why Your Landing Page Isn&apos;t Converting</a>
        ...
        <div className="bg-bg-panel border border-border rounded-xl py-10 px-8 text-center mt-14">
          ...
          <p className="text-[13px] text-fg-muted mt-2.5">Free audit live · results in under 2 minutes</p>
        </div>
