  ...
  return (
    <html lang="en">
      <body style={{ background: '#0a0a0a', color: '#e5e5e5', fontFamily: 'system-ui, sans-serif', padding: '4rem 1.5rem', textAlign: 'center' }}>
        ...
        <button onClick={reset} type="button" style={{ background: '#00c2a0', color: '#000', padding: '0.75rem 1.5rem', borderRadius: '0.75rem', border: 'none', fontWeight: 600, cursor: 'pointer' }}>
          Try again
        </button>
      </body>
    </html>
