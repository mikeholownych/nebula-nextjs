...
export const verticals: Record<string, Vertical> = {
  saas: {
    ...
    top_leak: 'Message match failure. The ad promises a specific outcome; the landing page opens with the product category. That gap costs 40-60% of clicks before visitors read the headline.',
    ...
    benchmark: 'SaaS trial page benchmark: 3.5% conversion on paid traffic. Pages scoring below 6/10 on audit consistently convert below 1.5%.',
