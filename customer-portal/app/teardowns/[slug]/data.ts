...
export const TEARDOWNS: Record<string, Teardown> = {
  basecamp: {
    ...
    summary: 'Nebula ran its 9-signal audit on basecamp.com. Score: 5.4/10, Grade C. Five specific findings — evidence-backed, not opinions.',
  ...
  notion: {
    ...
    grade: 'C',
    auditedAt: 'July 29, 2026',
    summary: 'Nebula ran its 9-signal audit on notion.so. Score: 6.1/10, Grade C. 417KB HTML payload — 3.4× heuristic max. H1/title keyword misalignment.',
