  ...
  return (
    <main id="main-content" className="max-w-3xl mx-auto px-5 pt-32 pb-24">
      ...
      <section className="mt-10">
        <h2 className="text-2xl font-bold text-fg mb-4 tracking-tight">
          Information We Collect
        </h2>

        <h3 className="text-lg font-semibold text-fg-muted mt-8 mb-3">
        ...
        <p className="text-fg-muted mb-3 font-semibold">
        ...
        <h3 className="text-lg font-semibold text-fg-muted mt-10 mb-3">
      ...
      <section className="mt-12">
        ...
        <p className="text-fg-muted mb-4 font-semibold">
      ...
      <div className="mt-12 p-6 bg-bg-muted/30 border border-white/5 rounded-xl">
        <h3 className="text-lg font-semibold text-fg-muted mt-0 mb-3">
          Contact Us
        </h3>
