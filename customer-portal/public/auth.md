...
{
  "agent_auth": {
    "skill": "https://nebulacomponents.com/auth.md",
    "register_uri": "https://nebulacomponents.com/api/agent/register",
    "supported_identity_types": ["anonymous"],
    "identity_types_supported": ["anonymous"],
    "anonymous": {
      "credential_types_supported": ["none"],
      "claim_uri": "https://nebulacomponents.com/auth.md",
      "revocation_uri": null
    },
...
2. **POST** to `https://nebulacomponents.com/api/agent/register` with `{ "agent_id": "<your-agent-id>", "purpose": "<your-use-case>" }`.
...
- **OpenID Configuration:** https://nebulacomponents.com/.well-known/openid-configuration
- **Protected Resource Metadata:** https://nebulacomponents.com/.well-known/oauth-protected-resource
- **Authorization Server Metadata:** https://nebulacomponents.com/.well-known/oauth-authorization-server
