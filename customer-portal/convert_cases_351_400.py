#!/usr/bin/env python3
"""Batch convert HTML case studies 351-400 to Next.js dark theme pages."""
...
def get_sorted_files():
    """Get sorted HTML files and return 351-400."""
    files = sorted(HTML_DIR.glob("*.html"))
    # Return files 351-400 (index 350-399)
    return files[350:400]
