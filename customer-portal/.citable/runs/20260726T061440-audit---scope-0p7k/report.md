...
- Run: `20260726T061440-audit---scope-0p7k`
- Command: `audit --scope`
- Target: url — https://nebulacomponents.shop
- Timestamp: 2026-07-26T06:14:40.516Z
- Tool version: 1.13.1; commit: e45bb64654ed2ec4654f7c8aa20fe1640e536e9b (dirty)
...
| --- | --- |
| Total findings | 34 |
| Deterministic observations | 29 |
| Heuristic / semantic findings | 5 |
| high | 3 |
| medium | 25 |
| low | 6 |
...
| --- | --- | --- |
| Retrieval eligibility | partial | 22 finding(s); 0 skipped check(s) |
| Source extraction and support | fail | 10 finding(s); 0 skipped check(s) |
...
- Subject: `https://nebulacomponents.shop/#FAQPage`
- Type: deterministic_observation; confidence: confirmed; deterministic: true
- Impact: legal:medium, ranking:medium
- Evidence:
  - not visible: "How long does the free landing page audit take?"
  - not visible: "What's included in the $97 Fix Pack?"
  - not visible: "Why do landing pages fail to convert paid traffic?"
...
- Subject: `https://nebulacomponents.shop/audit#FAQPage`
- Type: deterministic_observation; confidence: confirmed; deterministic: true
- Impact: legal:medium, ranking:medium
- Evidence:
  - not visible: "What does the free landing page audit check?"
  - not visible: "How long does the landing page audit take?"
  - not visible: "What happens after the free audit?"
- Remediation: Only mark up FAQs that are visible, substantive page content.
- Verify: Every FAQPage question string appears in visible text. (rerun `SCHEMA-007`)
...
- Subject: `https://nebulacomponents.shop/learning-centre/landing-page-intelligence-stack`
- Type: deterministic_observation; confidence: confirmed; deterministic: true
- Impact: retrieval:medium
- Evidence:
  - sitemap https://nebulacomponents.shop/sitemap.xml lists https://nebulacomponents.shop/learning-centre/landing-page-intelligence-stack; no matching page found
- Remediation: Regenerate sitemaps from live canonical URLs; remove retired URLs.
- Verify: Resolve every sitemap URL against the built output or deployed site. (rerun `TECH-010`)
...
### MEDIUM · SCHEMA-002 · Schema headline "Proof Before CTA: Why Social Proof Placement Determines Conversion" does not match visible title or H1

- Subject: `https://nebulacomponents.shop/learning-centre/proof-before-cta#Article`
- Type: deterministic_observation; confidence: confirmed; deterministic: true
- Impact: representation:medium
- Evidence:
  - schema headline: Proof Before CTA: Why Social Proof Placement Determines Conversion
  - visible title: Proof Before CTA: Social Proof Placement Guide | Nebula
  - H1: Proof Before CTA: The Simple Fix Most Landing Pages Miss
