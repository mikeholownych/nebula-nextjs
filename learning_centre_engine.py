...
def config() -> dict[str, Any]:
    ...
    return {
        ...
        "secondary_cta": {"label": "Buy the $97 Fix Pack", "href": "https://buy.stripe.com/9B63cvc2o7YMcid2Nk43S0j"},
        "policy": {
  ...
  <main class="wrap detail">
    ...
    <section class="panel cta-panel">
      ...
      <div class="actions">
        ...
        <a class="button secondary" href="https://buy.stripe.com/9B63cvc2o7YMcid2Nk43S0j">Buy the $97 Fix Pack</a>
      </div>
    </section>
  </main>
</body>
