...
def config() -> dict[str, Any]:
    ...
    return {
        ...
        "secondary_cta": {"label": "Buy the $97 Fix Pack", "href": "https://buy.stripe.com/5kQbJ1eawdj6eql1Jg43S0h"},
        "policy": {
  ...
  <main class="wrap detail">
    ...
    <section class="panel cta-panel">
      ...
      <div class="actions">
        ...
        <a class="button secondary" href="https://buy.stripe.com/5kQbJ1eawdj6eql1Jg43S0h">Buy the $97 Fix Pack</a>
      </div>
    </section>
  </main>
</body>
