...
def _render_html(audit, fix_path, overall, grade, projected, projected_grade, diagnosis, url):
  ...
  <div style="border-top:1px solid #e5e7eb;margin-top:16px;padding:16px 0;text-align:center;">
    <a href="https://buy.stripe.com/6oUfZh7M87YM5TPgEa43S0b" style="display:inline-block;padding:12px 32px;background:#059669;color:#fff;text-decoration:none;border-radius:6px;font-size:15px;font-weight:600;">Implement These Fixes — $147 →</a>
