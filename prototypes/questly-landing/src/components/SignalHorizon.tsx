...
export const SignalHorizon: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-[#080909] to-transparent z-10" />
      ...
      >
        <defs>
          ...
          <linearGradient id="signal-glow" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          <linearGradient id="signal-blue" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        {/* Diagnostic Measurement Nodes (dots at key signal peaks) */}
