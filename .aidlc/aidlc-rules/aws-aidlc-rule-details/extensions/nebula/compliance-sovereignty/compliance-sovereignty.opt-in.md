# Nebula Compliance & Sovereignty Extension
...
### Regulated Client Rules
- HIPAA: require signed BAA before any PHI processing
- GDPR: data processing agreement + EU-hosted or on-prem option
- EU AI Act (Aug 2026): risk documentation + human-in-the-loop with real authority
- DORA: full audit rights + independent operation proof

### Penalty Scale Reference
- GDPR: €20M or 4% global turnover
- EU AI Act: €35M or 7% revenue
- HIPAA: $1.9M/year per violation category
