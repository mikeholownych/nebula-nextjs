...
- Run: `20260908T101311-audit-cro-91b9`
- Command: `audit cro`
- Target: url — https://nebulacomponents.com
- Timestamp: 2026-09-08T10:13:11.742Z
...
| --- | --- |
| Total findings | 0 |
| Deterministic observations | 0 |
| Heuristic / semantic findings | 0 |

## Separate eligibility and observation states

| Dimension | Result | Evidence |
| --- | --- | --- |
| Retrieval eligibility | not_established | 0 finding(s); 0 skipped check(s) |
| Source extraction and support | not_established | 0 finding(s); 0 skipped check(s) |
...
No findings from the executed detectors. Absence of findings is not proof of eligibility — see skipped and incomplete checks above.
